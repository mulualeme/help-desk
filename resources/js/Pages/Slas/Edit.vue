...
const form = useForm({
    name: props.sla.name,
    description: props.sla.description || "",
    response_time_minutes: props.sla.response_time_minutes,
    resolution_time_minutes: props.sla.resolution_time_minutes,
    customer_id: props.sla.customer_id || "",
...
onMounted(() => {
    // Initialize hours from minutes
    responseHours.value = (props.sla.response_time_minutes / 60).toString();
    resolutionHours.value = (props.sla.resolution_time_minutes / 60).toString();
});
...
const submit = () => {
    ...
    form.put(route("slas.update", props.sla.id));
};
</script>
